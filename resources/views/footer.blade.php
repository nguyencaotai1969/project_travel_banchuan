...
<section id="footer">
    <div class="container">
        <div class="row text-left text-xs-center text-md-left mt-sm-6 p-4">
            ...
            <div class=" col-md-4">
                <div>
                    <h2><a href="{{route('trangchu')}}"><img src="{{asset('img/logo.png')}}" width="50%" alt="Trang Chủ Du Lịch"></a></h2>
                </div>
                <br>
                ...
                <ul class="list-unstyled quick-links">
                    ...
                    <li>
                        <a href="javascript:void();">
                            <b><img src="{{asset('img/logobank.png')}}"   width="71%"  alt=""></b>
                        </a></li>
                </ul>
            </div>
        </div>
    ...
    <section class="container-fluid sec-sub-footer">
        ...
        <div class="row text-center">
            <div class="col">
                <span>© 2019 <b> Copyright</b>: Nhóm 3</span>
            </div><!--.col-->
