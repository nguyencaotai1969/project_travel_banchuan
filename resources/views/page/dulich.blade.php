            ...
            <div class="col-md-3 col-sm-6">
                <div class="product-grid4">
                    ...
                    <div class="product-content">
                        <h3 class="title p-1"><a href="{{route('chitiettour',$tour->id)}}"><b>{{$tour->name}}</b> <img
                    ...
                    <a class="add-to-cart dat-tour-mien-bac" href="{{route('dattour',$params = ['id'=> $tour->id])}}"><b>Đặt Tour</b></a>
                </div>
            </div>
            @endforeach
        </div>
