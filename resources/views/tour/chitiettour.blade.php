...
@section('content')
    ...
    <div class="container chitiettour">
        <h3 class="text-center danhsachtour">{{$detail->name}}</h3>
        <div class="row">
            <div class="col-md-5 pt-3">

                <img class="col-md-12" src="../storage/tour/avatar/{{$detail->avatar}}" alt="" width="100%">
                ...
                <div class="row" style="padding: 13px">
                   ...
                   <table border="1" cellpadding="10" style="border:1px solid #3bea69">
                    ...
                    <div class="d-flex justify-content-center col-md-12 pt-2">
                        <a class="btn btn-primary" href="{{route('dattour',$params = ['id'=> $detail->id])}}">Đặt ngay</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="home-v" role="tabpanel">
                            <div class="sv-tab-panel  p-4">
                                <b><i class="fas fa-map-marker-alt">&nbsp</i>{!!$detail->lichtrinh!!}</b>
                            </div>
                        </div>
