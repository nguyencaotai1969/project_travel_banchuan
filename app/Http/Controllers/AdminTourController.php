...
{   public function AddTour(){
    ...
    public function SaveTour(Request $request){
        if ($request->isMethod('post')){
            ...
            $file_path_upload = $request->file('avatar')->store('public/tour/avatar/');
            Storage::move($file_path_upload,'public/tour/avatar/'.$new_name);
...
//        List tour
    $tour = DB::table('tb_tour')
        ->where('id',$id)
        ->first();
    return view('admin.update-tour',compact('tour'));
    }
